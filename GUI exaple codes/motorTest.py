...
fast_drill_button = ctk.CTkButton(group_3a, text="FAST DRILL", command=lambda: send_command('fastdrill'))
slow_drill_button = ctk.CTkButton(group_3b, text="SLOW DRILL", command=lambda: send_command('slowdrill'))
